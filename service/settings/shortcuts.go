...
const (
	...
	ShortcutTypstLineBreak     ShortcutID = "editor.typstLineBreak"
...
var shortcutDefinitions = []ShortcutDefinition{
	...
	{ShortcutTypstLineBreak, "Editor", "Insert Typst line break", "Insert \\ and continue on a new line.", ShortcutBinding{key.NameEnter, key.ModShortcut}},
